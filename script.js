...
var eyeLCoords,
  ...
  hairX,
  hairS;
//   let b = document.querySelector('.inputGroup')
//   var mb = document.querySelector(".jsLogin")
//   b.addEventListener('click', function() {
//     b.innerHTML = '<a href="https://birthday-cake-mu.vercel.app/"></a> <button id="login" class="jsLogin"></button>'
// });
